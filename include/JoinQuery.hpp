...
private:
     string plineitem, porder, pcustomer;
     ...
     unordered_set<int> fck;
     unordered_set<int> fok;
     unordered_set<int> cck;
  ...
  /**************************************************************************
   ...
   uint64_t ReadCustomer(string sParam);
   uint64_t ReadOrder();

   uint64_t ReadLineitem();
};
//---------------------------------------------------------------------------
